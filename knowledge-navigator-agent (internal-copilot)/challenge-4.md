...
1. Navigate through the topic flow and find where all variables are collected (email address, document name, description).
...
1. Navigate through the topic flow and identify where all variables are collected.
