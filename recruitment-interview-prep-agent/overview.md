...
You will start by creating the HR Interview Copilot framework and uploading key hiring documents. Next, you will implement resume evaluation and interview question generation using knowledge-grounded conversational intelligence. You will then automate shortlist reporting through Outlook using Power Automate. Finally, you will deploy the Copilot to Microsoft Teams to experience the full, conversational hiring workflow.
...
To begin, proceed to **Challenge 1** or navigate using the buttons at the bottom of the page.
